...
VL_INLINE_OPT VlCoroutine Vsa_pkg___024root___eval_initial__TOP__Vtiming__0(Vsa_pkg___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vsa_pkg__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsa_pkg___024root___eval_initial__TOP__Vtiming__0\n"); );
    ...
    if (VL_UNLIKELY((0U == __Vtask_tb_gemm_top__DOT__read_dims__1__fd))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_gemm_top.sv:111: Assertion failed in %Ntb_gemm_top.read_dims: [TB] Could not open ../sim/dims.txt - run golden_model.py first.\n",0,
                     64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
        VL_STOP_MT("/mnt/d/Infineon_Work/systolic_array/tb/tb_gemm_top.sv", 111, "", false);
    }
    ...
    VL_FCLOSE_I(__Vtask_tb_gemm_top__DOT__read_dims__1__fd); if (VL_UNLIKELY(
        ...
        VL_WRITEF_NX("[%0t] %%Fatal: tb_gemm_top.sv:115: Assertion failed in %Ntb_gemm_top.read_dims: [TB] dims.txt parse error (got %0d fields).\n",0,
                     64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name(),
                     32,__Vtask_tb_gemm_top__DOT__read_dims__1__code);
        VL_STOP_MT("/mnt/d/Infineon_Work/systolic_array/tb/tb_gemm_top.sv", 115, "", false);
    }
    if (VL_UNLIKELY((0U != VL_MODDIVS_III(32, vlSelfRef.tb_gemm_top__DOT__M, (IData)(8U))))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_gemm_top.sv:116: Assertion failed in %Ntb_gemm_top.read_dims: [TB] M=%0d must be a multiple of 8.\n",0,
                     64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name(),
                     32,vlSelfRef.tb_gemm_top__DOT__M);
        VL_STOP_MT("/mnt/d/Infineon_Work/systolic_array/tb/tb_gemm_top.sv", 116, "", false);
    }
    if (VL_UNLIKELY((0U != VL_MODDIVS_III(32, vlSelfRef.tb_gemm_top__DOT__N, (IData)(8U))))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_gemm_top.sv:117: Assertion failed in %Ntb_gemm_top.read_dims: [TB] N=%0d must be a multiple of 8.\n",0,
                     64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name(),
                     32,vlSelfRef.tb_gemm_top__DOT__N);
        VL_STOP_MT("/mnt/d/Infineon_Work/systolic_array/tb/tb_gemm_top.sv", 117, "", false);
    }
    if (VL_UNLIKELY(((VL_LTS_III(32, 0x40U, vlSelfRef.tb_gemm_top__DOT__M) 
        ...
        VL_WRITEF_NX("[%0t] %%Fatal: tb_gemm_top.sv:119: Assertion failed in %Ntb_gemm_top.read_dims: [TB] dims (%0dx%0dx%0d) exceed TB capacity (64x64x512).\n",0,
                     64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name(),
                     32,vlSelfRef.tb_gemm_top__DOT__M,
                     32,vlSelfRef.tb_gemm_top__DOT__N,
                     32,vlSelfRef.tb_gemm_top__DOT__K);
        VL_STOP_MT("/mnt/d/Infineon_Work/systolic_array/tb/tb_gemm_top.sv", 119, "", false);
    }
        ...
        while (VL_LTS_III(32, vlSelfRef.tb_gemm_top__DOT__unnamedblk8__DOT__unnamedblk9__DOT__tn, 
            ...
            while ((5U != (IData)(vlSelfRef.tb_gemm_top__DOT__dut__DOT__u_ctrl__DOT__state))) {
                ...
                if (VL_UNLIKELY(VL_GTS_III(32, __Vtask_tb_gemm_top__DOT__run_tile__4__guard, 
                                           ((IData)(0x60U) 
                                            + vlSelfRef.tb_gemm_top__DOT__K)))) {
                    VL_WRITEF_NX("[%0t] %%Fatal: tb_gemm_top.sv:176: Assertion failed in %Ntb_gemm_top.run_tile: [TB] Timeout waiting for 'done' (tile finished too slowly).\n",0,
                                 64,VL_TIME_UNITED_Q(1000),
                                 -9,vlSymsp->name());
                    VL_STOP_MT("/mnt/d/Infineon_Work/systolic_array/tb/tb_gemm_top.sv", 176, "", false);
                }
            }
            co_await vlSelfRef.__VtrigSched_h36e11883__0.trigger(0U, 
                                                                 nullptr, 
    ...
    VL_WRITEF_NX("=====================================================\n",0);
    VL_FINISH_MT("/mnt/d/Infineon_Work/systolic_array/tb/tb_gemm_top.sv", 281, "");
}

VL_INLINE_OPT VlCoroutine Vsa_pkg___024root___eval_initial__TOP__Vtiming__1(Vsa_pkg___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vsa_pkg__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsa_pkg___024root___eval_initial__TOP__Vtiming__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    co_await vlSelfRef.__VdlySched.delay(0x77359400ULL, 
                                         nullptr, "/mnt/d/Infineon_Work/systolic_array/tb/tb_gemm_top.sv", 
                                         286);
    VL_WRITEF_NX("[%0t] %%Fatal: tb_gemm_top.sv:287: Assertion failed in %Ntb_gemm_top: [TB] Global timeout - simulation did not finish.\n",0,
                 64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
    VL_STOP_MT("/mnt/d/Infineon_Work/systolic_array/tb/tb_gemm_top.sv", 287, "", false);
}
...
void Vsa_pkg___024root___eval_triggers__act(Vsa_pkg___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vsa_pkg__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsa_pkg___024root___eval_triggers__act\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
