...
REM
REM Generated by Vivado on Wed Aug 26 12:29:10 +0530 2026
...
echo "xvlog --incr --relax -prj gemm_top_vlog.prj"
call xvlog  --incr --relax -prj gemm_top_vlog.prj -log xvlog.log
